---
layout: post
title: AA Amyloidosis Patient Leaflet
permalink: /aaa
date:   2025-06-30
category: ['Leaflet']
tag: ['Portfolio']
...
<div class="row">
	...
	<div class="6u$ 12u$(small)">
		<h4>Context</h4>
		<p>Brief: Design and illustrate a patient-facing educational leaflet on AA amyloidosis — a serious but underdiagnosed complication of chronic inflammation. The audience: patients recently diagnosed, and their families. The constraint: the mechanism is genuinely complex, and the science cannot be simplified.</p>
	</div>
</div> 
...
![First draft — content structure and rough layout](assets/images/ARC/250630_ARC_draft.png)

**Final — delivered for print and web**
Mid way through the process it was clear that the final product needed to be printed so we switched to a 2 page layout, cleared for both print (300 dpi) and web (72 dpi) export. The leaflet is accurate at the protein-biology level while remaining navigable to a non-scientist reader. 

![AA amyloidosis leaflet — final view](assets/images/ARC/250630_ARC_doublepage.png)
